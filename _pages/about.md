...
* Statistical and computational methods for electronic health records (EHR), real-world data (RWD), and large-scale studies (like PLCO Cancer Screening Trial), with a particular focus on **genetic data analysis** for genetically personalized and early detection of **prostate cancer**.
