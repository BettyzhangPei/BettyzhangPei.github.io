...
* Statistical and computational methods for EHR, real-world data (RWD), and large-scale studies, with a particular focus on **genetic data analysis** for genetically personalized and early detection of **prostate cancer**.
